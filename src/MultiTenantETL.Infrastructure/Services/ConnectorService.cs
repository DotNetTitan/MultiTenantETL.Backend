...
public class ConnectorService : IConnectorService
{
    ...
    private static void ValidateTypeAndProvider(string type, string provider)
    {
        ...
        {
            ConnectorTypes.Database => new[] { ConnectorProviders.SqlServer, ConnectorProviders.PostgreSQL, ConnectorProviders.MySQL, ConnectorProviders.Oracle, ConnectorProviders.Snowflake },
